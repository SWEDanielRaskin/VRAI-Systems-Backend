...
class OpenAIRealtimeService:
    ...
    async def configure_session(self):
        ...
        if not is_business_hours:  # Only configure if we're in after-hours mode
            ...
            instructions = f"""You are a professional AI receptionist for {BUSINESS_FULL_NAME}.
    ...
    async def start_conversation(self):
        ...
        try:
            ...
            create_response = {
                ...
                "response": {
                    "modalities": ["text", "audio"],
                    "instructions": f"Say exactly: 'Thank you for calling {BUSINESS_FULL_NAME} how can I help you?'"
                }
            }
