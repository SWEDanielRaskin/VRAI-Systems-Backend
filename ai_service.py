...
class AIReceptionist:
        ...
        self.functions = [
            {
                ...
                "description": f"""Book an appointment for a customer at {BUSINESS_FULL_NAME}.
    ...
    def get_ai_response(self, user_id, message):
        ...
        try:
            ...
            system_prompt = f"""You are a professional AI receptionist for {BUSINESS_FULL_NAME}.
            ...
            if user_id:
                ...
                if is_false_confirmation:
                    ...
                    # Replace the response with a clarification message (disabled - let AI response through)
