    ...
    if override == 'business':
        ...
        if ai_hours_json:
            try:
                ...
                ai_hours = {
                    'Monday': {'start': None, 'end': None},  # Closed
                    'Tuesday': {'start': '09:00', 'end': '20:00'},
                    'Wednesday': {'start': '09:00', 'end': '17:00'},
                    'Thursday': {'start': '09:30', 'end': '17:00'},
                    'Friday': {'start': '09:30', 'end': '17:00'},
...
def test_sms():
    ...
    try:
        ...
        success = sms_service.send_sms(
            ...
            message=f"Test SMS from {BUSINESS_FULL_NAME}! This is a manual test."
        )
...
def list_services():
    ...
    try:
        logger.info("🔍 Attempting to fetch services from database...")
