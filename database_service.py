...
import pytz
from config import DATABASE_NAME, BUSINESS_FULL_NAME, BUSINESS_WEBSITE, PYTZ_TIMEZONE
...
class DatabaseService:
    ...
    def __init__(self, db_file=DATABASE_NAME, broadcast_event=None):
    ...
    def get_appointment_notes(self, appointment_id: str) -> Optional[str]:
            ...
            default_templates = [
                {
                    ...
                    'description': None,
                    'message_content': f"Hi {{name}}! Your {{service}} appointment is tomorrow at {{time}}. We're excited to see you! - {BUSINESS_FULL_NAME}",
                    'is_enabled': True,
                    'max_chars': 160,
                    'conditions': {
                        'hours_in_advance': 30,
                ...
                },
                {
                    ...
                    'description': None,
                    'message_content': f"Thanks for visiting {BUSINESS_FULL_NAME}, {{name}}! We hope you loved your {{service}}! Leave us a review for 15% off your next visit: https://www.{BUSINESS_WEBSITE}/testimonials/ Code: REVIEW15",
                    'is_enabled': True,
                    'max_chars': 320,
                    'conditions': {
                ...
                },
                {
                    ...
                    'message_content': f"Great news! Your $50 show-up deposit has been refunded to your payment method. Thanks for keeping your appointment at {BUSINESS_FULL_NAME}! 💫",
                    'is_enabled': True,
                    'max_chars': 160,
                    'conditions': {}
                },
                {
                    ...
                    'message_content': f"Hi! We missed your call to {BUSINESS_FULL_NAME}. I'm here to help! How can I assist you today?",
                    'is_enabled': True,
                    'max_chars': 160,
                    'conditions': {}
                }
